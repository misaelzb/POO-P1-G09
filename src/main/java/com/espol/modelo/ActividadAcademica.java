...
public class ActividadAcademica extends Actividad {
    ...
    // Herencia donde se llaman 2 constructores diferentes, para poder colocar los
    // valores iniciales.
    public ActividadAcademica(int id, String nombre, String descripcion, LocalDateTime fechaVencimiento,
            String prioridad, double tiempoEstimado, double avance, String tipo, String asignatura, String subtipo) {
    ...
    public ActividadAcademica(int id, String nombre, String descripcion, LocalDateTime fechaVencimiento,
            String prioridad, double tiempoEstimado, double avance, String tipo, String asignatura, String subtipo,
            ControladorSesionEnfoque historialTiempo) {
        super(id, nombre, descripcion, fechaVencimiento, prioridad, tiempoEstimado, avance, tipo);
        this.asignatura = asignatura;
        this.subtipo = subtipo;
    ...
    public ActividadAcademica(String nombre, String descripcion, LocalDateTime fechaVencimiento, String prioridad,
            double tiempoEstimado, String tipo, String asignatura, String subtipo) {
