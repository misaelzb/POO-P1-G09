...
public class InicializarApp {
    ...
    public void iniciar(ControladorControlDeHidratacion controlador_Hidratacion,
            ControladorActividad controladorActividad, ControladorSesionEnfoque controladorSesionEnfoque1) {
        ...
        controladorActividad.crearActividadPersonal(1, "Cita Médica", "Cita Médica muy importante",
                LocalDateTime.of(2025, 11, 30, 12, 00), "ALTA", 45, 0.0, "Centro Médico");
        controladorActividad.crearActividadAcademica(2, "Proyecto 1", "Proyecto a realizar",
                LocalDateTime.of(2025, 11, 30, 12, 00), "ALTA", 2880.0, 70, "POO", "PROYECTO",
                controladorSesionEnfoque);
        controladorActividad.crearActividadAcademica(3, "Tarea 1", "Tarea por realizar",
